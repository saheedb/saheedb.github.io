...
`pheatmap` is pretty intuitive and easy to use, but any plotting tool can be used to create the plots
...
I used ImageMagick (https://imagemagick.org/index.php), but many tools can be used to do this.  
